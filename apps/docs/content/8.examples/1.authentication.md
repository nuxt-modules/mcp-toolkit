...
5. For this manually configured API-key recipe, use soft authentication and guard every protected operation; OAuth resource servers should return 401 with their metadata challenge
