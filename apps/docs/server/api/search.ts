...
export default defineEventHandler(async (event) => {
  ...
  return streamText({
    ...
    system: `You are a helpful assistant for the Nuxt MCP Toolkit, a module for creating MCP servers in Nuxt. Use your knowledge base tools to search for relevant information before answering questions.
