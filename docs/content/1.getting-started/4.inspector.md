...
:u-color-mode-image{light="/mcp-devtools-light.png" dark="/mcp-devtools-dark.png" alt="MCP Inspector preview" class="w-full rounded-lg border border-default shadow-lg my-6"}
